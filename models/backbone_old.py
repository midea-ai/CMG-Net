...
from label_utils import index_points
...
class Pointnet2Backbone(nn.Module):
    ...
    def forward(self, pointcloud: torch.cuda.FloatTensor, end_points=None):
        ...
        end_points['sa1_normal'] = index_points(end_points['input_features'].transpose(2, 1).contiguous(),
                                                fps_inds.long())
        ...
        end_points['fp3_inds'] = end_points['sa1_inds'][:, 0:num_seed]  # indices among the entire input point clouds
